...
% TODO the definitions of ledgers and connectors are redundant here and in the model section
...
% enable payments between any sender and any recipient, due to the small-world network phenomenon (colloquially known as the ``six degrees of separation''). \cite{watts1998collective}\cite{albert1999internet} 
...
% TODO section 2 presents the overview of the protcol, 3 formalizes it and presents the atomic mode of execution
...
% TODO talk here about how todays payments require the connectors to be altruistic or bound by legal contract
